      ...
      <React.Fragment>
        ...
        >
          <div className="navbar-brand">
            <a href="https://skill-tree-retry2.web.app/" className="navbar-item">
              <img alt="SkillTree" src="/Tyro_logo.png"></img>
            </a>
          </div>
              ...
              {isAuthenticated ? (
                <div className="navbar-item has-dropdown is-hoverable">
                  ...
                  <div className="navbar-dropdown is-right">
					...
					<div className="navbar-item">
                      <Link to="/TodoList" className="button is-fullwidth">
                        <span className="icon">
					...
					<div className="navbar-item">
                      <Link to="/journal" className="button is-fullwidth">
                        <span className="icon">
