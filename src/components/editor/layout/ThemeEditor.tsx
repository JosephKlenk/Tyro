...
> {
  ...
  componentDidMount() {
    ...
    axios
      ...
      .then((response) => {
        const fontFamilyResponse = response.data.items
          .map((i) => {
  ...
  render() {
    const defaultSelectOptions = [
      {
        ...
        value: this.state.theme
          ? this.state.theme.nodeDesktopTextNodeWidth
          : "",
        options: [
          { value: "120px", title: "Narrow" },
          { value: "144px", title: "Normal" },
          { value: "188px", title: "Wide" },
          { value: "222px", title: "Very wide" },
        ],
      },
      {
        ...
        value: this.state.theme
          ? this.state.theme.nodeDesktopTextNodeHeight
          : "",
        options: [
          { value: "22px", title: "Short" },
          { value: "28px", title: "Normal" },
          { value: "36px", title: "Tall" },
          { value: "48px", title: "Very tall" },
        ],
      },
      {
        title: "Node font",
      ...
      },
      {
        ...
        options: [
          ...
          { value: "16px", title: "Normal" },
          { value: "24px", title: "Big" },
          { value: "32px", title: "Huge" },
        ],
      },
    ];
    ...
    const additionalSelectOptions = [
      ...
      },
      {
        ...
        value: this.state.theme
          ? this.state.theme.nodeActiveBackgroundColor
          : "",
        options: gradients,
      },
      {
      ...
      },
      {
        ...
        options: [
          { value: "92px", title: "Narrow" },
          { value: "108px", title: "Normal" },
          { value: "144px", title: "Wide" },
          { value: "188px", title: "Very wide" },
        ],
      },
      {
        ...
        value: this.state.theme
          ? this.state.theme.nodeMobileTextNodeHeight
          : "",
        options: [
          { value: "24px", title: "Short" },
          { value: "32px", title: "Normal" },
          { value: "38px", title: "Tall" },
          { value: "52px", title: "Very tall" },
        ],
      },
      {
        ...
        options: [
          ...
          { value: "14px", title: "Normal" },
          { value: "18px", title: "Big" },
          { value: "24px", title: "Huge" },
        ],
      },
      {
        title: "Heading font",
      ...
      },
      {
        ...
        options: [
          { value: "16px", title: "Small" },
          { value: "24px", title: "Normal" },
          { value: "32px", title: "Big" },
          { value: "48px", title: "Huge" },
        ],
      },
      {
    ...
    const compositionId = this.props.match.params.compositionId;
    if (this.state.doneUpdatingTheme) {
      ...
      <React.Fragment>
        <div className="level is-mobile p-4 has-background-light">
          ...
          <div className="level-right">
            <div className="level-item">
              <button
                className="button is-primary has-tooltip-bottom has-tooltip-multiline"
        ...
        <div className="columns">
                ...
                <div className="field">
                  ...
                  <div className="control">
                    <SketchPicker
                      color={
                        this.state.theme
                          ? this.state.theme.treeBackgroundColor
                          : ""
                      }
          ...
          <div className="column is-narrow">
            {this.state.theme && this.state.composition && (
              <CompositionDisplay
